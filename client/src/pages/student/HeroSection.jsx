        ...
        <div className='relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center'>\
            <div className='max-w-3xl mx-auto'>
                ...
                <form action="" className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto  mb-6'>
                    <Input type='text' className="flex-grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500" />
                ...
                <Button className="bg-pink-500 dark:bg-pink-900 text-pink-200 hover:bg-pink-900 rounded-full">Explore Courses</Button>
            </div>
        </div>
    )
}
